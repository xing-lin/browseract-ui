  ...
  return (
    ...
    >
      {active ? (
        ...
        <path
          fill="currentColor"
          d="M3.044 7.48a.458.458 0 1 0-.007-.915h-.005l-.947.002a.608.608 0 0 0-.678.606l-.005 6.623c0 .338.265.603.604.603h.026l.032.001.028-.001h.953-.001l.059-.002v-.006a.44.44 0 0 0 0-.87v-.011h-.779l.022-6.03zM14.347 6.817c-.284-.463-.706-.7-1.284-.724a1 1 0 0 0-.09-.006l-3.06-.01c.21-.63.325-1.309.325-1.918a6 6 0 0 0-.14-1.274l-.018-.05h-.001A1.64 1.64 0 0 0 8.49 1.597c-.866 0-1.519.722-1.519 1.68v.048q-.003.054 0 .097C6.93 5.01 5.662 6.35 4.026 6.536l-.052.006-.012 4.288v3.57h.217l.01.002h.05V14.4l7.588.003.135-.003c.31 0 .485-.08.76-.256a1.67 1.67 0 0 0 .59-.661.6.6 0 0 0 .087-.191l1.177-5.26a.6.6 0 0 0 .018-.197 1.7 1.7 0 0 0-.247-1.018m-.61.82-.015.06.005.001-1.252 5.55-.002.006a.45.45 0 0 1-.348.275h-.07l-7.232-.008-.002-6.13C6.064 6.83 7.136 6.236 7.68 4.77h.005l.017-.051q.088-.266.135-.514a5 5 0 0 0 .08-.907q-.04-.318.138-.522a.68.68 0 0 1 .48-.221c.354.012.712.484.713.752.001.004.085.421.085.863.001.432-.041.707-.06.81h-.008l-.01.047a4.6 4.6 0 0 1-.459 1.313l-.015.044.002.003a.6.6 0 0 0-.045.23c0 .39.424.39.652.39l3.646.005.112.003.056.002v.007l.087-.004c.163 0 .311.083.397.223.072.118.09.261.048.395"
        />
      )}
    </svg>
  );
